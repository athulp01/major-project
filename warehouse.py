...
class Warehouse:
    def __init__(self, port):
        ...
        _, self.toplpos  = sim.simxGetObjectPosition(self.client, topleft, -1, sim.simx_opmode_blocking)
        _, self.bottomrpos  = sim.simxGetObjectPosition(self.client, bottomright, -1, sim.simx_opmode_blocking)
